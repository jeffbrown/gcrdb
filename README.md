...
### Verification
From the workflow step `Deploy Cloud Run` copy out url `https://gcrdb-__________run.app` of the invoke endpoint:
```
Invoke endpoint:
https://gcrdb-__________run.app
```

Call the api endpoint:
```
curl https://gcrdb-__________run.app/gcrdb
```
